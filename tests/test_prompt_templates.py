...
def test_DocSearchTemplate():  # noqa
    ...
    assert embeddings_model.history[0].total_tokens == expected_initial_tokens
    assert embeddings_model.history[0].cost == expected_initial_tokens * cost_per_token
